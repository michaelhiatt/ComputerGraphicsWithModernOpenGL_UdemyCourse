...
void Shader::SetPointLights(PointLight * pLight, unsigned int lightCount)
{
	...
	for (size_t i = 0; i < lightCount; i++)
	{
		pLight[i].UseLight(uniformPointLight[i].uniformAmbientIntensity, uniformPointLight[i].uniformColour,
			...
			uniformPointLight[i].uniformConstant, uniformPointLight[i].uniformLinear, uniformPointLight[i].uiniformExponent);
	}
}
...
void Shader::SetSpotLights(SpotLight * sLight, unsigned int lightCount)
{
	...
	for (size_t i = 0; i < lightCount; i++)
	{
		sLight[i].UseLight(uniformSpotLight[i].uniformAmbientIntensity, uniformSpotLight[i].uniformColour,
			...
			uniformSpotLight[i].uniformConstant, uniformSpotLight[i].uniformLinear, uniformSpotLight[i].uiniformExponent,
...
void Shader::CompileShader(const char * vertexCode, const char * fragmentCode)
{
	...
	for (size_t i = 0; i < MAX_POINT_LIGHTS; i++)
	{
		...
		uniformPointLight[i].uiniformExponent = glGetUniformLocation(shaderID, locBuff);
	}
	...
	for (size_t i = 0; i < MAX_SPOT_LIGHTS; i++)
	{
		...
		uniformSpotLight[i].uiniformExponent = glGetUniformLocation(shaderID, locBuff);
